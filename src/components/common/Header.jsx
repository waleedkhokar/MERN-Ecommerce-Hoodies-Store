...
const Header = ({ darkMode, setDarkMode }) => {
    ...
    const navItems = [
        ...
        { name: 'Girls', path: '/products?category=girls' }, // Changed 'women' → 'girls'
                            ...
                            <div className="flex items-center justify-between p-6 border-b border-gray-800/30">
                                <div className="flex items-center gap-3">
                                    <div className={`w-10 h-10 rounded-lg flex items-center justify-center ${
                                        ...
                                        <span className={`font-bold ${darkMode ? 'text-black' : 'text-white'}`}>JS</span>
                                    </div>
                                    <div>
                                        <h2 className="font-black">JAVASCRIPT</h2>
                                        <p className="text-xs opacity-60">Wear Your Style</p>
                                    </div>
                                </div>
                            </div>
