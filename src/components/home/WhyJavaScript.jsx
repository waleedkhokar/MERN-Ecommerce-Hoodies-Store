    ...
    const features = [
        {
            ...
            description: "100% high-quality cotton blend for ultimate comfort"
        },
        {
            icon: "✂️",
            title: "Tailored Fit",
            description: "Designed for perfect fit and movement"
        },
        {
            icon: "🏔️",
            title: "Rawalakot Made",
            description: "Handcrafted in the mountains of Pakistan"
        },
        {
            icon: "💎",
            title: "Minimal Design",
            description: "Clean aesthetics with no unnecessary branding"
        },
        {
            icon: "🌱",
            title: "Sustainable",
        ...
        },
        {
            icon: "🚚",
            title: "Fast Delivery",
            description: "Across Pakistan in 3-7 working days"
        }
    ];
