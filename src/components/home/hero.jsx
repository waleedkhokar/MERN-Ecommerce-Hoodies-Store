      ...
      <div className="container mx-auto px-4 md:px-6 lg:px-8 py-8 md:py-12">
        ...
        <div className="flex flex-col lg:flex-row items-center justify-between gap-8 md:gap-12 lg:gap-16">
          ...
          >
            ...
            >
            Premium hoodies designed for both boys & girls. 
            </motion.p>
            ...
            >
              {[
                { text: "Minimal design", emoji: "✨", bg: darkMode ? "bg-purple-500/10" : "bg-purple-100", border: darkMode ? "border-purple-500/30" : "border-purple-300" },
                { text: "Maximum comfort", emoji: "😌", bg: darkMode ? "bg-blue-500/10" : "bg-blue-100", border: darkMode ? "border-blue-500/30" : "border-blue-300" },
              ].map((item, idx) => (
                <motion.div
                  key={idx}
